    ...
    <div className="w-full h-full  md:pb-0 flex flex-col md:bg-white md:rounded-2xl overflow-hidden dark:bg-darks ">
      ...
      <div className="h-[cal(100%-52px)] md:px-4 overflow-y-auto space-y-2  pt-6 md:pt-0 pb-2 md:mt-0 dark:px-2 mb-2 ">
        <div className="space-y-2 mt-3">
          <div
            key={selectKalema?.id}
            className="w-full  dark:text-dark-text p-5 group  bg-white  flex justify-between gap-5 space-x-4 md:space-x-2  border-gray-100 border-[0.3px] dark:border-0 rounded-xl md:hover:rounded-xl transition-all items-start duration-500 dark:bg-darkz shadow-sm"
          >
